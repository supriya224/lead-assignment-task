...
function Footer() {
    return <footer className="bg-white dark:bg-gray-900 fixed bottom-0 w-full z-1">
        <div className="mx-auto w-full max-w-screen-xl p-4 py-2 lg:py-8">
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                ...
                <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
                    <a href="fb" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    ...
                    <a href="GFithuv" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    ...
                    <a href="#Dribble" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                        <svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
